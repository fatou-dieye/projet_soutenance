...
exports.register = async (req, res) => {
  try {
    ...
    const photoPath = req.file ? `https://projet-soutenance-y3d8.onrender.com/uploads/${req.file.filename}` : null;
...
const updateUsersStatus = async (req, res) => {
  ...
  const updateUser = async (req, res) => {
    try {
      ...
      if (req.file) {
        utilisateur.photo = `https://projet-soutenance-y3d8.onrender.com/uploads/${req.file.filename}`;
      }
