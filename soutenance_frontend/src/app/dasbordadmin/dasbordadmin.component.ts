...
import { NiveauPoubelleService } from '../services/niveaupoubelle.service';
...
export class DasbordadminComponent  implements OnInit , OnDestroy {
  ...
  constructor(private DasbordadminService: DasbordadminService,
    private  niveauPoubelleService:  NiveauPoubelleService, private pointageService: PointageService, private router: Router
