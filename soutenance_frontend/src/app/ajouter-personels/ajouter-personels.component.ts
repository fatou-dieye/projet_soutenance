...
import { GestionpersonnelService } from '../services/gestionpersonel.service';
...
@Component({
  ...
  templateUrl: './ajouter-personels.component.html',
  styleUrl: './ajouter-personels.component.css'
})
